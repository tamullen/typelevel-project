...
object Cats {
  ...
  val aSimpleList = applicativeList.pure(42) // List(42)
  ...
  val aFlatMappedList = flatMapList.flatMap(List(1,2,3))(x => List(x, x + 1))
  ...
  type ErrorOr[A] = Either[String, A] // [error, desired]
